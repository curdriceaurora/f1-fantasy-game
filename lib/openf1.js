...
export function normalizeRaceWeekend(calendarRace, fetchedRace, fineSummary = { drivers: {}, teams: {}, documents: [] }) {
  ...
  return {
    ...
    // Optional, explicit team-seat substitutions. Scoring resolves each session
    // independently around the inferred race occupant for that baseline seat.
    seatOccupants: calendarRace.seatOccupants || {},
