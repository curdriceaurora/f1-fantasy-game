...
// the competitor. Matched against the document title / URL slug, whose wording is
// stable, rather than the free-text reason.
...
export function driverFaultDriver(url, text) {
  if (!DRIVER_FAULT_INFRINGEMENT.test(`${url} ${text}`)) return null;
