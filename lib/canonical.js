...
const TEAM_MANUAL_ALIASES = {
  ...
  // Martin labels Racing Bulls "RBPT" on his roster and race sheets — it is
  // Lawson and Lindblad's team, not Verstappen and Hadjar's. Mapping it to
  // red-bull collapsed the two constructors: every RBPT pick was scored as Red
  // Bull, and reading his sheets merged both rows into one.
  'racing bulls': ['rbpt', 'rb', 'visa cash app rb', 'racing bulls f1 team'],
